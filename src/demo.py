...
# parser.add_argument('--environment', default = '/data/pick_and_drop_exps/Pranav Bedroom2', help='Environment name')
# parser.add_argument('--environment', default = './sample_save_directory', help='Environment name')
# parser.add_argument('--environment', default = '/data/pick_and_drop_exps/VenthyaKitchen2', help='Environment name')
# parser.add_argument('--environment', default = '/data/pick_and_drop_exps/VenthyaKitchen3', help='Environment name')
